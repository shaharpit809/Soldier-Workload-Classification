...
shinyServer(
  ...
  function(input,output)
  {
    ...
    output$ann <- renderTable({
      ...
      c <- data.frame(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12,c13,c14) #testing
      ...
      result <- data.frame(Base_Load, Low_Work_Load, High_Work_Load) #coz u want it show which values are what
    ...
    output$plotann <- renderPlot({
      ...
      plot(net, rep = "best")  #best is used to print out the best value out of all the computation else it will print rep no of times
